<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IcetexPago_Matricula.aspx.cs" Inherits="Aplicacion_Bancafe_Pago_Matricula" %>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <table style="text-align: left;">
                    ...
                    <tr>
                        ...
                        <td class="style1">
                            <asp:TextBox ID="TextBox10" runat="server" ReadOnly="True" Width="192px">$620.000</asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
                        ...
                        <td class="style1">
                            <asp:TextBox ID="TextBox11" runat="server" ReadOnly="True" Width="192px">$830.000</asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
                    ...
                    <tr>
                        ...
                        <center>    
                            <asp:Button ID="Button2" runat="server" Height="33px" Text="Ingresar Pago" 
