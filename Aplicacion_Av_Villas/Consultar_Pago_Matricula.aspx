<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Consultar_Pago_Matricula.aspx.cs" Inherits="Aplicacion_Bancafe_Pago_Matricula" %>
            ...
            <asp:Panel ID="Panel1" runat="server" Visible="False">
                <table style="text-align: left;">
                    ...
                    <tr>
                        ...
                        <td class="style6">
                            <asp:TextBox ID="TextBox18" runat="server" ReadOnly="True" Text="SI" 
                    ...
                    <tr>
                        ...
                        <td class="style6">
                            <asp:TextBox ID="TextBox19" runat="server" ReadOnly="True" Text="NO" 
